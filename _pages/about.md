...
<div style="width: 100%; overflow-x: auto;">
  <table style="width: 100%; font-size: 17px; border-collapse: collapse; border: none;">
    ...
    <tr>
      ...
      <td style="border: none; word-wrap: break-word;"> <strong><i>Zhengwang</i></strong> has his first publication <em>A highly polarization-sensitive near-infrared photodetector based on two-dimensional germanane/a-CdS heterostructure</em> on <em>2D Materials</em>. Congratulations!</td> 
    </tr>
    <tr>
